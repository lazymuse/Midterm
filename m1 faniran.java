...
void demo() {
  ...
  if (k%180 > 90) {
    ...
    /* REMOVE THIS LINE */        fill(255,0,0);   b( 1, "rabbit ball", rabX,  rabY );
    /* REMOVE THIS LINE */        fill(150,150,0); b( 2, "corn ball", cornX,  cornY );
    /* REMOVE THIS LINE */        fill(0,100,255);   b( 3, "fox ball", foxX,  foxY );  
    fill(255,0,255);
...
void ran() {
  if (wall) {
         rabX=  random( 280,right-20 );   rabY=  random( top,bottom );
         cornX=  random( 280,right-20 );       cornY=  random( top,bottom );
         foxX=  random( 280,right-20 );     foxY=  random( top,bottom );         
  }else{
         rabX=  random( left+50,right-20 );   rabY=  random( top,bottom );
         cornX=  random( left+50,right-20 );       cornY=  random( top,bottom );
         foxX=  random( left+50,right-20 );     foxY=  random( top,bottom );         
  }
}
